...
\begin{table}[h!]
	\begin{tabular}{|p{4cm}|p{4cm}|p{4cm}|p{4cm}|}
		...
		\begin{tabular}[c]{@{}l@{}}Verslo reikalavimai \\ (verslo inžinieriaus \\ požiūris)\end{tabular}                        &                     &
...
\begin{table}[h!]
	\begin{tabular}{|p{4cm}|p{4cm}|p{4cm}|p{4cm}|}\hline
		...
		Sistemoje kaupsime epidemiologinius duomenis apie renginius ir viešąsias maitinimo įskaitas, kada kokia žmonės ten lankėsi, kas dalyvavo renginyje ar maitinimo istaigoje prieš susirgdamas.
		...
		Visus duomenis matys tik valstybinių organizacijų atstovai turintys priviliaciją matyti šiuos duomenis.                                   \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[h!]
	\begin{tabular}{|p{4cm}|p{4cm}|p{4cm}|p{4cm}|}\hline
		...
		Po sistemos sukūrimo vartotojai bus apmokomi naudotis sistema, tačiau tikimasi, kad vartotojai jau bus naudojasi kitomis, panašiomis sistemomis.     &

		Programine sistema pasiekti galima tik nurodytoje darbo vietoje arba prisijungus į virtualų privatų tinklą(VPA) užtikrinant darbo iš namų galimybę. &
...
\begin{table}[h!]
	\begin{tabular}{|p{4cm}|p{4cm}|p{4cm}|p{4cm}|}\hline
		...
		Programų sistema įgyvendima visus funkcinius ir nefunkcinius reikalavimus atsižvelgdama ekonominius ir politinius reikalavimus iškeltus suinteresuotų šalių 
...
Atsižvelgus į SWOT analizę, nuspręsta tolimesnę sistemos specifikaciją orientuoti pagal stiprybes: automatinis saviizoliacijos pažeidimų fiksavimą, duomenų agregavimą iš skirtingų institucijų, automatinį privačių asmenų įspėjimą apie saviizoliaciją ar riziką, sistemos kūrimą finansuoja valstybė.
	      ...
	      \begin{enumerate}
		      \item{Galimybė gauti pavojingų šalių sąrašą iš ,,Sveikatos apsaugos ministerija"}
		            \begin{enumerate}
			            ...
			            \item{Galimybė pavojingų šalių sąrašą perduoti privatiems asmenims}
		            \end{enumerate}
	      \end{enumerate}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Saviizoliacijos pabaigos fiksavimas. 
		\item Pranešimas apie privalomą saviizoliaciją. Užfiksavus privalomą saviizoliaciją, asmuo yra įspėjamas SMS žinute. (2 prioritetas). Inicijuojantis įvykis - užfiksuota saviizoliacija. Įvestis - asmens duomenys ir saviizoliacijos vieta. Išvestis - SMS pranešimas privačiam asmeniui, kuriam reikalinga saviizoliacija. 
		\item Pavojingų šalių sąrašo atnaujinimas. Sveikatos apsaugos ministerija atnaujina sąrašą šalių, pagal kurį sprendžiama apie privalomą izoliaciją. (6 prioritetas). Inicijuojantis įvykis - naujas SAM paskelbia naują pavojingų šalių sąrašą. Įvestis - pavojingų šalių sąrašas. Išvestis - atnaujintas pavojingų šalių sąrašas.
	\end{itemize}
	\item Tikrinti saviizoliacijos laikymąsi:
	\begin{itemize}
		\item Priminimas apie saviizoliacijos laikymosi patvirtinimą. Privačiam asmeniui, kuriam reikalinga saviizoliacija, kas 12 valandų gauna pranešimą apie saviizoliacijos laikymosi patvirtinimą. (3 prioritetas). Inicijuojantis įvykis - kalendorinis (kas 12 valandų). Įvestis - saviizoliacijų sąrašas
		\item Saviizoliacijos laikymosi patvirtinimas. Privatus asmuo, kuriam reikalinga saviizoliacija, gauna pranešimą apie reikalingą saviizoliacijos patvirtinimą. Patvirtinti saviizoliaciją jis gali atsiųsdamas savo lokaciją arba nuotrauką. (4 prioritetas).
		\item Saviizoliacijos pažeidimo fiksavimas. Privačiam asmeniui, kuris tvirtina savo saviizoliaciją dalindamasis buvimo vieta, atsiuntus koordinates, nutolusias nuo deklaruotos saviizoliacijos vietos daugiau nei 100 metrų, fiksuojamas saviizoliacijos pažeidimas. (5 prioritetas).
	Jei atsiunčiama nuotrauką ir randamas pažeidimas, jis fiksuojamas.  (\ref{img:business_process_identify_violation} pav.)
	\end{itemize}
	\item Pranešti apie pažeidimus policijai:
	\begin{itemize}
		\item Reikalingų duomenų perdavimas policijai (pranešimas apie saviizoliacijos pažeidimą). Užfiksavus pažeidimą, visi reikalingi pranešimui duomenys perduodami policijai. (8 prioritetas). 
	\end{itemize}
\end{itemize}
...
\subsection{Kaip?}
Skyrelyje "Kaip?" pateikiama kokių informacinių, skaičiavimo, komunikavimo ar kitokių paslaugų prireiks posistemės įgyvendinimui.
\begin{itemize}
	\item Visos užduotys aprašytos "Kodėl?" skyrelyje turi būti įgyvendintos ir pasiekiamos kompiuterizuotai.
	\item Užduotis "Įspėjimai apie užsikrėtusio virusu asmens lankymąsi" turi būti automatizuota, o įspėjimai išsiunčiami tekstine žinute automatiškai.
	\item Užduočių rezultatai turi būti kiek galima tikslesni, klaidos tokio tipo projekte neatleistinos.
	\item Saugumo reikalavimai turi būti aukšti. Projekte dirbama su asmenine žmonių informacija kuri gali būti susijusi su žmogaus sveikatos informacija. Sistema turi būti kiek galima saugesnė.
\end{itemize}
