...
\begin{itemize}
	...
	\item Vytautas Krivickas (el. paštas \href{mailto:vytautas.krivickas@mif.stud.vu.lt}{vytautas.krivickas@mif.stud.vu.lt}) -- priežiūros ir palaikymo grupės perspektyva ir KFS3.
	\item Matas Savickis (el. paštas \href{mailto:matas.savickis@mif.stud.vu.lt}{matas.savickis@mif.stud.vu.lt}) -- programuotojo perspektyva ir KFS2.
...
Šiame skirsnyje pateikiama pataisyta reikalavimų specifikacija. Visi pataisymai pažymėti {\color{blue}mėlyna} spalva.
...
\begin{center}
	...
	\begin{longtable}{|C{2cm}|L{5cm}|L{8cm}|}
		...
		{\color{blue} 1.Epidemiologas gali užfiksuoti susirgimą.} \textbf{Pradiniai duomenys} - žmogaus asmeniniai duomenys, kontaktiniai duomenys, saviizoliacijos pradžios ir numatomos pabaigos data, sarašas su kuo kontaktavo susirgęs žmogus.
		...
		{\color{blue} 3. Turi būti saugomos visos artefaktų versijos. }                                   \\ \hline
		\reqCode                                                          &
		Programų sistemos patikimumo reikalavimai                         &
		{\color{blue} 1.} Sistema turi išlikti pasiekiama 99 procentus laiko.
		{\color{blue} 2.} Įvykus sistemos tiktims sistema turi sugebėti automatiškai pasileisti iš naujo neprarasdama duomenų.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \\ \hline
		\reqCode                                                          &
		Programų sistemos išbaigtumas                                     &
		Užsakovui priimtimas ne daugiau nei vienas tikdis per savaitę.
		...
		{\color{blue} 1.} Dėl trikdžių sistema gali neveikti 1 valandą per diena.
		{\color{blue} 2.} Sistema turi atitikti top 10 OWASP saugumo rekomendacijų.                                                                                                                                   
		{\color{blue} 3.} Sistemoje gali būti ne daugiau nei vienas įsilaužimas per mėnesį.                                                                                                                                   
		                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  \\ \hline
		\reqCode                                                          &
		Programų sistemos atkuriamumo reikalavimai                        &
		{\color{blue} 1.} Sistema turi galėti atsikurti per valandą po sutrikimo.
		{\color{blue} 2.} Per valandą turi būti atkuriami prarasti duomenys ir funkcionalumas.
		{\color{blue} 3.} Trikdis turi būti rastas ir pašalintas per savaitę.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
		{\color{blue} 4. Duomenys atsarginėse kopijose turi būti ne senesni nei 24h. }
		\\ \hline
		\reqCode                                                          &
		Programų sistemos prieinamumo reikalavimai                        &
		{\color{blue} 1.} Per dieną sistema turi išlikti funkcionali 23,8 valandas.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                
		...
		{\color{blue} 1} Perkelti sistemą į kitą technologinę platformą turi kainuoti ne daugiau 10000 žmogaus darbo valandų.
		{\color{blue} 2} Perkelti sistemą į kitą kompiuterinę platformą turi kainuoti ne daugiau 20 žmogaus darbo valandų.
		{\color{blue} 3} Perkelti sistemą į naujesnę operacinės sistemos versiją (atnaujinti OS) turi kainuoti ne daugiau 100 žmogaus darbo valandų.
		{\color{blue} 4} Perkelti sistemos duomenis į nauja DBVS turi kainuoti ne daugiau 200 žmogaus darbo valandų.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            \\ \hline
		\reqCode                                                          &
		Programų sistemos instaliuojamumo reikalavimai                    &
		{\color{blue} 1} Programai instaliuoti turi pakakti 40 žmogaus darbo valandų.
		{\color{blue} 2} Maksimalus procentas kodo kurį reiktų pakeisti instaliuojant sistemą yra 0,01\% {\color{blue} kodo eilučių}.
		{\color{blue} 3} Maksimalus procentas failų kuriuos reiktų pakeisti instaliuojant sistemą yra 0,01\%.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \\ \hline
		\reqCode                                                          &
		Programų sistemos atitikimo keliamumo standartams reikalavimai    &
		Keliamumo reikalavimai atitinką apibrėžtą vidinį standartą pagal ISO {\color{blue} 25000}.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  \\ \hline
		\reqCode                                                          &
		Programų sistemos pakeičiamumo reikalavimai                       &
		Sistema nebus keičiama.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \\ \hline									\reqCode &
		Programų sistemos analizuojamumo reikalavimai                     &
		Trikdžio priežastis sistemoje turi būti išsiaiškinta per 20 žmogaus darbo valandų.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      \\ \hline
		\reqCode                                                          &
		Programų sistemos keičiamumo reikalavimai                         &
		Trikžio priežastis sistemoje turi būti pašalinta per 20 žmogaus darbo valandų.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         \\ \hline
		\reqCode                                                          &
		...
		Automatiniai testai sistemoje nevykdomi.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            \\ \hline
		\reqCode                                                          &
		Programų sistemos tvarkomumo reikalavimai                         &
		{\color{blue} 1 Sistemos techninė specifikacija turi atitikti įmonės vidinį standartą.}
		{\color{blue} 2} Sistema turi būti atkuriama per 1 žmogaus darbo valandą.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               \\ \hline
		\reqCode                                                          &
