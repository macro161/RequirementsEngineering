...
\begin{center}
	...
	\begin{longtable}{|C{2cm}|L{5cm}|L{8cm}|}
		...
		{\color{blue} 1.} Užduotys sistemoje turi turėti unikalius identifikatorius                                   \\ \hline
		{\color{blue} 2. Sistemos artefaktai turi būti versijuojami }                                  \\ \hline
		...
		Sistemoje gali būti ne daugiau nei vienas įsilaužimas per mėnesį.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     \\ \hline
		\reqCode                                                          &
		...
		{\color{blue} 3.} Trikdis turi būti rastas ir pašalintas per savaitę.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \\ \hline
		{\color{blue} 4. Duomenys atsarginėse kopijose turi būti ne senesni nei 24h. }
		\reqCode                                                          &
		Programų sistemos prieinamumo reikalavimai                        &
		Per dieną sistema turi išlikti funkcionali 23,8 valandas.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                \\ \hline
		\reqCode                                                          &
		...
		{\color{blue} 2.} Surastas trikdis programiniam kode turi būti pašalintas per savaitę.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \\ \hline
